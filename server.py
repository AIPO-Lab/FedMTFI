...
class ClusterServer:
    ...
    def train_student_with_teachers(self, public_loader, dataset_name: str = "FashionMNIST", epochs: int = None, current_round: int = 0, logger=None, client_signals: List[Dict[str, Any]] = None):
        ...
        print(f"[ClusterServer] SHAP-based feature importance weighting: {'ENABLED' if CFG.use_shap else 'DISABLED'}")
        ...
        for e in range(1, epochs + 1):
            ...
            for x, y in public_loader:
                ...
                # Prepare importance weights for this batch if available AND SHAP is enabled
                ...
                # Total loss: KD + CE + feature alignment with importance weighting (if SHAP enabled)
