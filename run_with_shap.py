"""
Run FedMTFI with SHAP enabled (non-interactive version).
This script runs the full training pipeline with SHAP-based feature importance weighting.
"""
...
def main_with_shap():
    """Main training function with SHAP enabled."""
    ...
    print("=" * 60)
    print("FedMTFI - WITH SHAP-BASED FEATURE IMPORTANCE WEIGHTING")
    print("=" * 60)
    ...
    for dataset_name in ["FashionMNIST", "CIFAR10"]:
        ...
        # Multi-teacher distillation (THIS USES SHAP IF ENABLED)
    ...
    # Save results
    results_file = "federated_learning_results_WITH_SHAP.xlsx"
    ...
    print(f"\n[FedMTFI] Training WITH SHAP completed!")
